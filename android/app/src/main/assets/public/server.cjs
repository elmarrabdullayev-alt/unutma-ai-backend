...
app.post("/api/transcribe-audio", async (req, res) => {
  try {
    ...
    if (!base64Audio) {
      return res.status(400).json({ error: "S\u0259s fayl\u0131 g\xF6nd\u0259rilm\u0259yib." });
    }
    const audioPart = {
      inlineData: {
    ...
    const response = await ai.models.generateContent({
      ...
      contents: {
        parts: [
          audioPart,
          {
            text: "Bu s\u0259s fayl\u0131 Az\u0259rbaycan dilind\u0259dir. Z\u0259hm\u0259t olmasa t\u0259l\u0259ff\xFCz edil\u0259n s\xF6zl\u0259ri d\u0259qiq Az\u0259rbaycan \u0259lifbas\u0131 v\u0259 orfoqrafiyas\u0131 il\u0259 transkripsiya et. He\xE7 bir \u0259lav\u0259 giri\u015F v\u0259 ya \u015F\u0259rh yazma, yaln\u0131z t\u0259miz m\u0259tni qaytar."
          }
        ]
      }
    });
